...
function build(options, config) {
    return __awaiter(this, void 0, void 0, function* () {
        let polymerProject = new polymer_build_1.PolymerProject(config);
        ...
        let sourcesStream = polymerProject.sources()
            ...
            .pipe(gulpif(/\.html$/, new optimize_streams_1.InlineCSSOptimizeStream(optimizeOptions.css)))
        ...
        let unbundledPhase = polymer_build_1.forkStream(buildStream)
            ...
            .pipe(gulpif(options.insertDependencyLinks || false, new prefetch_1.PrefetchTransform(polymerProject)))
        ...
        let unbundledPostProcessing = Promise.all([loadSWConfig, streams_1.waitFor(unbundledPhase)]).then((results) => {
            let swConfig = results[0] || undefined;
